...
- [[#sec:smart-city-example][Running example: The NebulaStream smart city]]
- [[#sec:installation-and-execution][Installation and execution]]
- [[#sec:docker-services][Docker services]]
- [[#sec:configuration][Configuring NebulaStream]]
- [[#sec:visualization][Visualizing the input data]]
- [[#sec:web-ui][The NebulaStream web UI]]
- [[#sec:running-nebulastream-queries][Running NebulaStream queries]]
- [[#example-queries][Example queries]]
- [[#sec:actuating-events][Actuating events in the 3D smart city]]
- [[#sec:the-java-client][The Java client]]
- [[#sec:query-merging][Query merging]]

* Running example: The NebulaStream smart city
:PROPERTIES:
:CUSTOM_ID: sec:smart-city-example
:END:
...
:PROPERTIES:
:CUSTOM_ID: sec:installation-and-execution
:END:
...
:PROPERTIES:
:CUSTOM_ID: sec:actuating-events
:END:
