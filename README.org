...
TODO Describe different combinations
...
.sink(MQTTSinkDescriptor::create("ws://mosquitto:9001","q1", "user", 1000, MQTTSinkDescriptor::TimeUnits::milliseconds,0, MQTTSinkDescriptor::ServiceQualities::atLeastOnce, true));
#+end_src
...
.sink(MQTTSinkDescriptor::create("ws://mosquitto:9001","q2", "user", 1000, MQTTSinkDescriptor::TimeUnits::milliseconds,0, MQTTSinkDescriptor::ServiceQualities::atLeastOnce, true));
#+end_src
